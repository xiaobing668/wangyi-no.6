...
public class MainActivity extends AppCompatActivity {
    ...
    private List<Note> loadNotesFromDatabase() {
        ...
        Cursor cursor = null;
        try{
            cursor = db.query(TodoContract.TodoNote.TABLE_NAME, null,null,null,null,null,
            ...
            while (cursor.moveToNext()){
                    ...
                    note.setPriority(Note.Priority.from(intPriority));
                    result.add(note);
            }
    ...
    private void deleteNote(Note note) {
        ...
        int  deletedRows = db.delete(TodoContract.TodoNote.TABLE_NAME,
    ...
    private void updateNode(Note note) {
        ...
        String selection = TodoContract.TodoNote._ID+"=?";
        String[] selectionArgs = new String[]{String.valueOf(note.id)} ;
        int rows = db.update(TodoContract.TodoNote.TABLE_NAME, values,
                selection,
               selectionArgs);
        if (rows > 0) {
            notesAdapter.refresh(loadNotesFromDatabase());
